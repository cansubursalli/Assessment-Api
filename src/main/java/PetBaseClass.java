...
public class PetBaseClass {
    ...
    public void checkPetUpdate(Long id,String value,String key) throws IOException { //Update oldugunu kontrol etme
    ...
    public void validatePetDeletion(Long id) throws  IOException{  //Bilgisayarim turkce oldugu icin
